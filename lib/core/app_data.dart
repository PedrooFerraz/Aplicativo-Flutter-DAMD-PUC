...
static List<Food> foodItems = [
  ...
  Food(
    ...
    1,
    false,
    "Porção generosa de batatas fritas crocantes, servidas com molho especial.",
    4.7,
    FoodType.lanches,
    250,
  ),
  Food(
    ...
    1,
    false,
    "Pão macio com salsicha, batata palha, molho de tomate e mostarda.",
    4.3,
    FoodType.lanches,
    190,
  ),
  Food(
    ...
    1,
    false,
    "Carne suculenta grelhada, queijo derretido, alface, tomate e molho da casa.",
    4.8,
    FoodType.lanches,
    300,
  ),
